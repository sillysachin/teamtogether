...
public class GeneralExtras extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mViewPager.getViewPager().setAdapter(new FragmentStatePagerAdapter(getChildFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                switch (position % 2) {
                    case 0:
                        return RecyclerViewFragment.newInstance(15,37,193);
                    case 1:
                        return RecyclerViewFragment.newInstance(4,34,194);
                    default:
                ...
                switch (page) {
                    case 0:
                        return HeaderDesign.fromColorAndUrl(
                                ...
                                "http://ts.icias2015.org/university/images/college_3.jpg");
                    case 1:
                        return HeaderDesign.fromColorAndUrl(
                                getResources().getColor(R.color.primaryColorMedium),
                                "http://ts.icias2015.org/university/images/college_4.jpg");
                }
