...
for($i=0;$i<$j;$i++){
	...
	$holder[$holder_c]=substr($holder[$holder_c],1,9);
	$holder_c++;
	$h_c++;
	if($h_c!=$i_c)
		echo ",";
...
echo "\"ATTACH\":[";
$messages2 = file_get_contents('http://notifoid.net/mce/index.php?option=com_jsonexport&table=rnbje_kunena_attachments&fields=id,mesid,size,folder,filename');
