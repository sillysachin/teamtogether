...
class KunenaView extends JViewLegacy {
	...
	final public function poweredBy() {
			...
			$credits .= JHtml::_('kunenaforum.link', '', JText::_(''), '', '', 'follow', array('style'=>'display: inline; visibility: visible; text-decoration: none;'));
			$credits .= ' <a href="" rel="follow" target="_blank" style="display: inline; visibility: visible; text-decoration: none;">'.JText::_('').'</a>';
