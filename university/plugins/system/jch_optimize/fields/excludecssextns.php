...
else
{
        ...
        class JFormFieldExcludecssextns extends JFormFieldExclude
        {
                ...
                protected function getFieldOptions()
                {
                        ...
                        $aExcludesCssExtns = $oParams->get('excludeCssComponents', array());

                        foreach ($aExcludesCssExtns as $sExcludeCssExt)
                        {
                                $aOptions[$sExcludeCssExt] = $sExcludeCssExt;
                        }

                        return array_merge($this->getOptions('css', 'extensions'), $aOptions);
                }
