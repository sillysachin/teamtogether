...
else
{
        ...
        class JFormFieldExcludejsextns extends JFormFieldExclude
        {
                ...
                protected function getFieldOptions()
                {
                        ...
                        $aExcludesJsExtns = $oParams->get('excludeJsComponents', array());

                        foreach ($aExcludesJsExtns as $sExcludeJsExt)
                        {
                                $aOptions[$sExcludeJsExt] = $sExcludeJsExt;
                        }

                        return array_merge($this->getOptions('js', 'extensions'), $aOptions);
                }
