...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="http://ts.icias2015.org/university/templates/jsn_cube_pro/favicon.ico" type="image/x-icon" />
...
//Radio styling End
    ...
    <body>
        ...
        <div class="container">
            ...
            <h1>No of Devices Registered: <?php echo $num; ?></h1>
            <hr/><?php if($wrong==1) echo "<h1 style=\"font-size:20px\">Wrong Username or Password!</h1>";
if($success==1) echo "<h1 style=\"font-size:20px\">Successfully sent notifications to {$result}/{$num} devices, failures : {$fail}.</h1>"; 
if($deleted==TRUE) echo "<h1 style=\"font-size:20px\">Deleted $delenum duplicate users.</h1>";
?>
<?php echo validation_errors(); ?>
<div class="notifier">
  <a href="http://ts.icias2015.org/university"> <img src="http://ts.icias2015.org/university/images/logo_white.png" style="margin-left:auto;margin-right:auto;display:block"/></a>
                            <?php echo form_open('') ?>
...
<input type="password" name="delete" id="none" value="none" style="display:none;" />
<textarea rows="3" name="message" cols="25" class="txt_message" placeholder="Type notification here.."></textarea>
